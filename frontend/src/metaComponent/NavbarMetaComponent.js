import AvatarMetaComponent from "./AvatarMetaComponent";
import DropdownMetaComponent from "./DropdownMetaComponent";

const NavbarMetaComponent = (props) =>{
              ...
              <button type="button" className="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    <div className="relative ml-3">
                        <AvatarMetaComponent></AvatarMetaComponent>
                    </div>
                </div>
            </div>
        </div>
...
export default NavbarMetaComponent;