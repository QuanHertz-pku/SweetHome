const MetaLablist = (props) => {
    return (
        <div className="h-auto w-full">
            <div className="flex w-full justify-between">
                <div className="ml-1 font-mono font-thin text-slate-600">Laboratory</div>
            ...
            <ul className="ml-1 pl-0 font-mono text-sm font-thin text-slate-700">
                <li className="flex items-center hover:bg-white">
                    ...
                    <div className="ml-1">TravelPlan</div>
                </li>
                <li className="flex items-center hover:bg-white">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="h-4">
                    ...
                    <div className="ml-1">SelfInspect</div>
                </li>
                <li className="flex items-center hover:bg-white">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="h-4">
                    ...
                    <div className="ml-1">AIFriend</div>
                </li>
            </ul>
        </div>
    );
}
export default MetaLablist;